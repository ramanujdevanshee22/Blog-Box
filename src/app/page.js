...
export default async function Home() {
  ...
  return (
    <>
      ...
      <NavBar/>
    <div className="flex items-center justify-center bg-white dark:bg-black overflow-hidden pt-8 font-WorkSans">
      <div className="flex flex-col lg:pt-5 md:flex-row items-center justify-between w-full max-w-6xl px-4">
        <div className="flex flex-col items-start max-w-md md:text-left">
          <h1 className="text-4xl md:text-5xl font-bold text-PrimaryBlack dark:text-white mb-4">Welcome to BlogBox</h1>
          ...
          <Link href="/login" className="text-lg text-white bg-SecondaryPink hover:bg-SecondaryOrange px-6 py-3 rounded-full transition duration-300">
